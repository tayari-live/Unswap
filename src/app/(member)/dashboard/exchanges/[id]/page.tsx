    ...
    <div className="max-w-[800px] mx-auto px-6 lg:px-10 pt-12 pb-32">
      ...
      <div className="mb-10">
        ...
        <div className="flex flex-wrap items-center gap-3 font-sans text-[15px] text-[var(--fg)]/70">
          ...
          <span>{n} nights · {swap.mode === "points" ? `${n * (swap.pointsPerNight ?? 0)} points` : "Direct Swap"}</span>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="space-y-4 font-sans text-[15px]">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-[var(--fg)]">{swap.mode === "points" ? n * (swap.pointsPerNight ?? 0) : "Direct Swap"}</span>
            </div>
          </div>
        </div>
