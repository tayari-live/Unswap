      ...
      <div className="flex-1 flex flex-col min-w-0 h-full relative">
        ...
        <div className="flex items-center gap-3 p-4 border-b border-[var(--hair)] bg-[var(--surface)] sticky top-0 z-10 text-sm">
          ...
          <div className="relative flex-shrink-0">
            <div className="w-8 h-8 rounded-full bg-[var(--navy)]/10 text-[var(--fg)] flex items-center justify-center text-xs font-bold">
          ...
          <div className="min-w-0">
            <div className="font-bold text-[var(--fg)] truncate leading-tight">{other?.fullName ?? "Member"}</div>
            {otherTyping ? (
        ...
        <div ref={scrollRef} onScroll={handleScroll} className="flex-1 overflow-y-auto p-4 md:p-6 bg-[var(--chat-bg)]">
          {messages.length === 0 && (
                          ...
                          isImageData(m.attachmentUrl) ? (
                            ...
                            >
                              ...
                              <span className="min-w-0">
                                <span className="block text-xs font-semibold text-[var(--fg)] truncate">{fileKind(m.attachmentUrl)}</span>
                  ...
                  {!isTemp && (
                    <div className="relative flex-shrink-0 self-center">
                      <button
                        ...
                        className="p-1 rounded-full text-neutral/50 hover:text-[var(--fg)] hover:bg-black/5 transition-colors"
                      >
              ...
              <div className="mb-3">
                {isImageData(attachment) ? (
                  ...
                  <div className="inline-flex items-center gap-2.5 rounded-lg border border-[var(--hair)] bg-[var(--background)] px-3 py-2 pr-2">
                    ...
                    <span className="text-xs font-semibold text-[var(--fg)]">{fileKind(attachment)}</span>
                    <button type="button" onClick={() => setAttachment(null)} aria-label="Remove attachment" className="w-6 h-6 rounded-full text-neutral hover:text-[var(--fg)] flex items-center justify-center">
                      <X size={14} />
                    </button>
                  </div>
                )}
      ...
      <div className="hidden lg:flex w-80 xl:w-96 flex-col border-l border-[var(--hair)] bg-[var(--surface)] flex-shrink-0 h-full overflow-y-auto">
        ...
        {hasTrip ? (
          <div className="p-5">
            ...
            <h3 className="font-display font-bold text-[var(--fg)] text-lg leading-tight truncate">
            ...
            <div className="py-3 border-t border-[var(--hair)] mb-5 space-y-2.5">
              ...
              {swapStage && (
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-sm text-[var(--fg)]">{swapStage}</span>
                </div>
              )}
            </div>
