...
export function MessageButton({
  ...
  return (
    <button
      ...
      className={
        className ??
        "inline-flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl text-sm font-semibold text-[var(--fg)] border border-[var(--hair)] hover:border-[var(--navy)] disabled:opacity-50 transition-colors"
      }
    >
