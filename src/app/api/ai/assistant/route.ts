...
HOW UNSWAP WORKS
- Members exchange homes instead of paying for accommodation. Two modes: Simultaneous (both members swap at the same time) and Credits (host now, earn credits, redeem them for a stay later). 1 night hosted = 1 credit; short-term hosting of 7 to 14 nights earns credits at 1.5×. 1 credit = 1 night stayed.
