...
HOW UNSWAP WORKS
- Members exchange homes instead of paying for accommodation. Two modes: Simultaneous (both members swap at the same time) and Points (host now, earn points, redeem them for a stay later). 1 night hosted = 1 point; short-term hosting of 7 to 14 nights earns points at 1.5×. 1 point = 1 night stayed.
