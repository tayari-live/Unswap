    ...
    >
      <div className="max-w-[1200px] mx-auto flex items-center justify-between px-6 h-20">
        ...
        <nav className={`hidden md:flex items-center gap-10 text-[12px] font-bold tracking-[0.15em] uppercase transition-colors duration-300 ${isLight ? "text-[var(--navy)]/60" : "text-white/70"}`}>
          ...
          <a href="/#homes" className={`transition-colors duration-200 ${isLight ? "hover:text-[var(--navy)]" : "hover:text-white"}`}>
            Homes
          </a>
          <a href="/#how" className={`transition-colors duration-200 ${isLight ? "hover:text-[var(--navy)]" : "hover:text-white"}`}>
            How It Works
          </a>
          <a href="/#pricing" className={`transition-colors duration-200 ${isLight ? "hover:text-[var(--navy)]" : "hover:text-white"}`}>
            Membership
          </a>
        </nav>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <Link
            ...
            className={`hidden sm:inline-block text-[12px] font-bold uppercase tracking-wider transition-colors duration-200 ${
              isLight ? "text-[var(--navy)]/80 hover:text-[var(--navy)]" : "text-white/80 hover:text-white"
            }`}
          >
            Log In
          </Link>
          <Link
            ...
            className={`hidden sm:inline-flex text-[12px] font-bold uppercase tracking-wider px-6 py-3 rounded-full transition-colors duration-200 ${
              isLight ? "text-white bg-[var(--navy)] hover:bg-[var(--navy-dark)]" : "text-[var(--navy)] bg-[var(--gold)] hover:bg-[var(--gold-hover)]"
            }`}
          >
            Request Access
          </Link>
